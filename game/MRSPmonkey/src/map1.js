...
class map1 extends Phaser.Scene{
  ...
  */
  ...
  //---------------------Poubelle----------------------------
          if ((bodyA.id == '26' && bodyB.id == '35') && (player1.pad.buttons[2].pressed)) {
              if (player1.inv != 0) {
                player1.inv = 0;
                console.log('inventaire joueur 1 : ', player1.inv);
              }
  ...
  //------------------matières premières----------------------
          else if ((bodyA.id == '26' && bodyB.id == '33') && (player1.pad.buttons[2].pressed)) {
            if (player1.inv == 0) {
              player1.inv = "malt";
              console.log('inventaire joueur 1 : ', player1.inv);
              console.log(temps);
          ...
          else if ((bodyA.id == '26' && bodyB.id == '31') && (player1.pad.buttons[2].pressed)) {
              if (player1.inv == 0) {
                player1.inv = "levure";
                console.log('inventaire joueur 1 : ', player1.inv);
              }
  ...
  //----------------------Livraison---------------------------------
          else if ((bodyA.id == '17' && bodyB.id == '26')) {
  ...
  //---------------------Poubelle----------------------------
          if ((bodyA.id == '27' && bodyB.id == '35') && (player2.pad.buttons[2].pressed)) {
              if (player2.inv != 0) {
                player2.inv = 0;
                console.log('inventaire joueur 2 : ', player2.inv);
              }
  ...
  //------------------matières premières----------------------
          else if ((bodyA.id == '27' && bodyB.id == '33') && (player2.pad.buttons[2].pressed)) {
            if (player2.inv == 0) {
              player2.inv = "malt";
              console.log('inventaire joueur 2 : ', player2.inv);
              console.log(temps);
          ...
          else if ((bodyA.id == '27' && bodyB.id == '30') && (player2.pad.buttons[2].pressed)) {
              if (player2.inv == 0) {
                player2.inv = "eau";
                console.log('inventaire joueur 1 : ', player2.inv);
              }
          }
          else if ((bodyA.id == '27' && bodyB.id == '31') && (player2.pad.buttons[2].pressed)) {
              if (player2.inv == 0) {
                player2.inv = "levure";
                console.log('inventaire joueur 2 : ', player2.inv);
              }
  ...
  //----------------------Livraison---------------------------------
          else if ((bodyA.id == '17' && bodyB.id == '27')) {
  ...
  //---------------------Poubelle----------------------------
        if(player3.pad != undefined){
          if ((bodyA.id == '28' && bodyB.id == '35') && (player3.pad.buttons[2].pressed)) {
              if (player3.inv != 0) {
                player3.inv = 0;
                console.log('inventaire joueur 3 : ', player3.inv);
              }
  ...
  //------------------matières premières----------------------
          else if ((bodyA.id == '28' && bodyB.id == '33') && (player3.pad.buttons[2].pressed)) {
            if (player3.inv == 0) {
              player3.inv = "malt";
              console.log('inventaire joueur 3 : ', player3.inv);
              console.log(temps);
          ...
          else if ((bodyA.id == '28' && bodyB.id == '30') && (player3.pad.buttons[2].pressed)) {
              if (player3.inv == 0) {
                player3.inv = "eau";
                console.log('inventaire joueur 3 : ', player3.inv);
              }
          }
          else if ((bodyA.id == '28' && bodyB.id == '31') && (player3.pad.buttons[2].pressed)) {
              if (player3.inv == 0) {
                player3.inv = "levure";
                console.log('inventaire joueur 3 : ', player3.inv);
              }
  ...
  //-------------------Empatage----------------------------------
          else if ((bodyA.id == '22' && bodyB.id == '28') && (player3.pad.buttons[2].pressed)) {
  ...
  //----------------------Livraison---------------------------------
          else if ((bodyA.id == '17' && bodyB.id == '28')) {
  ...
  //---------------------Poubelle----------------------------
          if ((bodyA.id == '29' && bodyB.id == '35') && (player4.pad.buttons[2].pressed)) {
              if (player4.inv != 0) {
                player4.inv = 0;
                console.log('inventaire joueur 4 : ', player4.inv);
              }
  ...
  //------------------matières premières----------------------
          else if ((bodyA.id == '29' && bodyB.id == '33') && (player4.pad.buttons[2].pressed)) {
            if (player4.inv == 0) {
              player4.inv = "malt";
              console.log('inventaire joueur 4 : ', player4.inv);
              console.log(temps);
          ...
          else if ((bodyA.id == '29' && bodyB.id == '30') && (player4.pad.buttons[2].pressed)) {
              if (player1.inv == 0) {
                player1.inv = "eau";
                console.log('inventaire joueur 4 : ', player4.inv);
              }
          }
          else if ((bodyA.id == '29' && bodyB.id == '31') && (player4.pad.buttons[2].pressed)) {
              if (player4.inv == 0) {
                player4.inv = "levure";
                console.log('inventaire joueur 1 : ', player4.inv);
              }
          }
          else if ((bodyA.id == '29' && bodyB.id == '32') && (player4.pad.buttons[2].pressed)) {
              if (player4.inv == 0) {
                player4.inv = "houblon";
                console.log('inventaire joueur 4 : ', player4.inv);
              }
  ...
  //-------------------Concassage machine1-----------------------
          else if ((bodyA.id == '29' && bodyB.id == '34') && (player4.pad.buttons[2].pressed)) {
            if (player4.inv == "malt") {
              console.log("En préparation !!");
              player4.inv = 0;
              dispMalt.setFrame(1);
  ...
  //-------------------Empatage----------------------------------
          else if ((bodyA.id == '22' && bodyB.id == '29') && (player4.pad.buttons[2].pressed)) {
  ...
  //-----------------------Réfrigérant---------------------------
          else if ((bodyA.id == '23' && bodyB.id == '29') && (player4.pad.buttons[2].pressed)) {
  ...
  //----------------------Livraison---------------------------------
          else if ((bodyA.id == '17' && bodyB.id == '29')) {
